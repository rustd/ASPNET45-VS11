<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PostDetails.aspx.cs" Inherits="Talk_Outline4_1.PostDetails" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--Show all comments--%>
    <asp:Repeater ID="blogPostComments" runat="server" DataSourceID="showcommentsds">
        <HeaderTemplate>
            <strong>Comments for this post</strong>
        </HeaderTemplate>
        <ItemTemplate>
            <article class="post">
            <%# HttpUtility.HtmlEncode(Eval("Author")) %>
    ...
    <asp:FormView ID="insertcomment" runat="server" DataSourceID="insertcommentds" DefaultMode="Insert"
        ...
        <InsertItemTemplate>
            ...
            <asp:TextBox runat="server" ID="commenttext" Text='<%# Bind("CommentText") %>' TextMode="MultiLine" />
            <br />
